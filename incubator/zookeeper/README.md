...
| `NetworkPolicy.ApiVersion` | The API Version for NetworkPolicy resources in this Kubernetes cluster. | `extensions/v1beta1` |
| `NetworkPolicy.AllowExternal` | When `false`, only connections from pods with the generated client label will be accepted. | `true` |
